...
\end{abstract}
	...
	\subsection{Root-MUSIC}
		...
		\end{equation}
		%
		where $z = e^{-j{\beta}\sin{\theta}}}$ and each $C_{ij}$ is an element of the matrix $C = E_{n}{E_{n}}^H$.
		
		After performing matrix multiplication, the sum of the terms on the main diagonal will be weighted by $z^0$, the sum of the terms directly above it $C_ijrh The terms on the main diagonal with all hav
