...
\end{abstract}
	...
	\section{Results}
		...
		\begin{tabular}{|P{\colwidth}|P{\colwidth}|P{\colwidth}|P{\colwidth}|}
			...
			& & & \\
			\hline
			\multirow{3}{\colwidth}{\centering Beamforming} & $-40^{\circ}$ & $-40^{\circ}$ & $-40^{\circ}$ \\
			\cline{2-4}
			...
			& $50^{\circ}$ & $50^{\circ}$ & $50^{\circ}$\\
			\hline
			\multirow{3}{\colwidth}{\centering Root-MUSIC} & $-40^{\circ}$ & $-40^{\circ}$ & $-40^{\circ}$ \\
			\cline{2-4}
			& $-10^{\circ}$ & $-10^{\circ}$ & $-10^{\circ}$\\
			\cline{2-4}
			& $50^{\circ}$ & $50^{\circ}$ & $50^{\circ}$\\
			\hline
			\multirow{3}{\colwidth}{\centering ESPRIT} & $-40^{\circ}$ & $-40^{\circ}$ & $-40^{\circ}$ \\
			\cline{2-4}
			& $-10^{\circ}$ & $-10^{\circ}$ & $-10^{\circ}$\\
			\cline{2-4}
			& $50^{\circ}$ & $50^{\circ}$ & $50^{\circ}$\\
		...
		\begin{tabular}{|P{\colwidthC}|P{\colwidthB}|P{\colwidthB}|P{\colwidthB}|P{\colwidthB}|P{\colwidthB}|P{\colwidthB}|}
			...
			& & & & & & \\
			\hline
			%\multirow{2}{\colwidthB}{\centering $-40^{\circ}$ & $\omega=\pi/3$} & \multirow{2}{\colwidthB}{\centering\textbf{BF}} & \multirow{2}{\colwidthB}{\centering\textbf{Capon}} & \multirow{2}{\colwidthB}{\centering\textbf{MUSIC}} & \multirow{2}{\colwidthB}{\centering\textbf{I-MUSIC}} & \multirow{2}{\colwidthB}{\centering\textbf{R-MUSIC}} & \multirow{2}{\colwidthB}{\centering\textbf{ESPRIT}}\\
			\multirow{2}{\colwidthC}{\centering $-40^{\circ}$ \& $\omega=\pi/3$} & \multirow{2}{\colwidthB}{\centering $-40^{\circ}$} & \multirow{2}{\colwidthB}{\centering no peak} & \multirow{2}{\colwidthB}{\centering no peak} & \multirow{2}{\colwidthB}{\centering $-40^{\circ}$} & \multirow{2}{\colwidthB}{\centering $-40^{\circ}$} & \multirow{2}{\colwidthB}{\centering $-40^{\circ}$}\\
			& & & & & & \\
			\hline
			\multirow{2}{\colwidthC}{\centering $10^{\circ}$ \& $\omega=\pi/3$} & \multirow{2}{\colwidthB}{\centering $10^{\circ}$} & \multirow{2}{\colwidthB}{\centering no peak} & \multirow{2}{\colwidthB}{\centering no peak} & \multirow{2}{\colwidthB}{\centering $10^{\circ}$} & \multirow{2}{\colwidthB}{\centering $10^{\circ}$} & \multirow{2}{\colwidthB}{\centering $10^{\circ}$}\\
			& & & & & & \\
			\hline
			\multirow{2}{\colwidthC}{\centering $50^{\circ}$ \& $\omega=\pi/7$} & \multirow{2}{\colwidthB}{\centering $50^{\circ}$} & \multirow{2}{\colwidthB}{\centering no peak} & \multirow{2}{\colwidthB}{\centering no peak} & \multirow{2}{\colwidthB}{\centering $50^{\circ}$} & \multirow{2}{\colwidthB}{\centering $50^{\circ}$} & \multirow{2}{\colwidthB}{\centering $50^{\circ}$}\\
			& & & & & & \\
			\hline
		\end{tabular}
