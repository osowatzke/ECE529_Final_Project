...
% Updated: 12/05/2023
%
% Subject: Class compares direction of arrival algorithms while varying
% paramters such as ULA size, number of correlation samples, SNR, source
% spacing, and correlation between source signals.
%

%% Case 1
% Evaluating the effects of ULA size
% Perform DOA estimation with 4 antenna elements
o = doa_algorithm_comparison(...
    'fig_num',      1,...
    'num_elements', 4);
o.run();
