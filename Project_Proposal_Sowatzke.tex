...
\begin{document}
	...
	All of my project software will be implemented in MATLAB. I plan to compose all the required functions and classes except those already provided by MATLAB. Some of MATLAB-provided functions will be sourced from varying toolboxes. These toolboxes include the DSP System Toolbox, the Signal Processing Toolbox, and the Phased Array System Toolbox.
