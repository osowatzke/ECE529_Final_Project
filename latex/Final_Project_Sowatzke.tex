...
\end{IEEEkeywords}
	...
	Future improvements to this work involve research on optimal thresholding to detect sources in the spatial spectrums and adding additional software to implement these thresholding schemes. Monte Carlo regressions could be run to evaluate the probabilities of detection corresponding to each thresholding scheme. Overall, the theory provided in this paper along with the corresponding simulations should serve as a firm foundation for understanding and implementing direction of angle estimation.
